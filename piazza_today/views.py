...
def home_page(request):
    ...
    return render(request, 'piazza_today/home_page.html', {'pa_time':pa_time, 'lv_time':lv_time, 'header_date':header_date, 'lunch':lunch, 'dinner':dinner, 'lunch_food':lunch_food, 'dinner_food':dinner_food})
